...
public class TwitterLoginActivity extends ZipBaseActivity {

    // Note: Your consumer key and secret should be obfuscated in your source code before shipping.
    private static final String TWITTER_KEY = "NgYykAokXuSoNgv4OSS4kuvpx";
    private static final String TWITTER_SECRET = "M7NniAiwFe13SWgG3ySU1F7zAJBwwYCSRBuzho88pvxGMxrZWi";

    public static final String TAG = TwitterLoginActivity.class.getName();
    @Override
